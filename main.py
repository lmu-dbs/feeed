...
if __name__=='__main__':
    BY_TYPE = ["simple_stats","trace_length","trace_variant","trace_diversity","activities",
               "distinct_activities","start_activities","end_activities","repetitions",
               "comparison_based","dfg_based","eventropies","epa_based"]
    BY_NAME =['n_events', 'n_traces', 'n_variants', 'ratio_variants_per_number_of_traces',
              ...
              'coverage_variants', 'heterogeneity_rate_variants', 'rel_coverage_variants',
              'similarity_rate_variants', 'advanced_trace_diversity', 'simple_trace_diversity',
              'n_unique_activities',
              ...
              'complexity_factor', 'distinct_activities_max', 'distinct_activities_mean',
              'distinct_activities_min', 'distinct_activities_non_overlap',
              'distinct_activities_std', 'event_density',
              'n_unique_start_activities', 'rel_unique_start_activities', 'start_activities_min',
              'start_activities_max', 'start_activities_mean', 'start_activities_median',
              'start_activities_std', 'start_activities_variance', 'start_activities_q1',
              'start_activities_q3', 'start_activities_iqr', 'start_activities_skewness',
              'start_activities_kurtosis',
              'n_unique_end_activities', 'rel_unique_end_activities', 'end_activities_min',
              ...
              'avg_loop_size_per_trace', 'avg_loops_per_trace', 'avg_traces_with_loop',
              'avg_traces_with_repetition', 'max_loop_size_per_trace', 'max_loops_per_trace',
              'n_traces_with_loop', 'n_traces_with_repetition',
              'average_affinity', 'average_edit_distance', 'deviation_from_random',
              'lempel_ziv_complexity', 'number_of_successions', 'number_of_ties', 'structure',
              'avg_node_degree_dfg', 'coeff_of_connectivity_dfg', 'cyclicity_dfg',
              'cyclomatic_number_dfg', 'density_dfg', 'max_node_degree_dfg',
              'n_cut_vertices_dfg', 'n_edges_dfg', 'n_nodes_dfg', 'separability_ratio_dfg',
              'sequentiality_ratio_dfg', 'structure_dfg',
