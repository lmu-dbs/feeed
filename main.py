...
features_by_name = extract_features('test_logs/Sepsis.xes',
                                    ['n_traces', 'n_unique_traces', 'ratio_unique_traces_per_trace',
                                     ...
                                     'eventropy_trace', 'eventropy_prefix', 'eventropy_global_block', 'eventropy_lempel_ziv',
...
assert len(expected_features.keys()) == len(features_by_name.keys()), f"{len(expected_features.keys())} vs. {len(features_by_name.keys())}"
assert expected_features.keys() == features_by_name.keys(), f"{expected_features.keys()} vs. {features_by_name.keys()}"
assert expected_features == features_by_name, f"{expected_features} vs. {features_by_name}"
...
with open("output.json", "w") as json_file:
    json.dump(features_by_type, json_file, default=default_handler)
